                ...
                <div class="deals__container ppad">
                    <div>                        
                        <div class="deals__row xpad">
                            <p class="page__title">Edit Passenegr Class </p>
                            <div class="deal__action--container">
                    
                            </div>
                        </div>
                        <hr>
                        <form  method="POST" action="{{url('/update-passenger-class/'.$findClass->id)}}"  enctype="multipart/form-data" class="deals__row xpad">
                            @csrf
