                ...
                <div class="deals__container ppad">
                    <div>                        
                        <div class="deals__row xpad">
                            <p class="page__title">Edit Admin </p>
                            <div class="deal__action--container">
                    
                            </div>
                        </div>
                        <hr>
                        <form  method="POST" action="{{url('/update-admin/'.$editAdmin->id)}}"  enctype="multipart/form-data" class="deals__row xpad">
                            @csrf
                            ...
                            <select name="role" class="input--field">
                                ...
                                <option  value="{{$role->permission}}" {{$editAdmin->role_id == $role->id  ? 'selected' : ''}}>{{$role->name}} </option>
                                @endforeach   
                            </select>
