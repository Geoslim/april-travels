    ...
    <div class="mainContainer">
        ...
        <header class="header">
            ...
            <div class="header__column">
                ...
                <form action="{{url('/add-bookings/')}}" method="POST"class="header__form">
                    @csrf
                
                    <div class="header__form--container">
                        <p class="header__form--container-description">From</p>
                        <div class="header__form--container-body">
                            <input type="text" id="airport_name" name="airport_one" class="header__form--container-body-text typeahead search-input"
                                placeholder="Kano International Airport" autocomplete="off">
                    ...
                    <div class="header__form--container">
                        ...
                        <div class="header__form--container-body">
                            <input name="airport_to" class="header__form--container-body-text typeahead"
                                placeholder="Heathrow International Airport" autocomplete="off">
                        </div>
                    </div>
                    <div class="header__form--container header__form--container-screens">
                        <p class="header__form--container-description">Departure</p>
                        <div class="header__form--container-body">
                            <input type="date" name="departure" class="header__form--container-body-text"
                    ...
                    <div class="header__form--container header__form--container-screens">
                        ...
                        <div class="header__form--container-body">
                            <input type="date" name="arrival" class="header__form--container-body-text"
                                data-date-format="DD MMMM YYYY" value="2019-10-09">
                    ...
                    <div class="header__form--radio">
                        <p>
                            <input type="radio"  id="oneway" name="radio-group" value="one_way" checked>
                            <label for="oneway">ONE WAY</label>
                        </p>
                        <p class="extra__padding">
                            <input type="radio"  id="roundtrip" name="radio-group" value="round_trip">
                            <label for="roundtrip">ROUND TRIP</label>
                        </p>
                        <p>
                            <input type="radio"   id="destination" value="multiple_destination" name="radio-group">
