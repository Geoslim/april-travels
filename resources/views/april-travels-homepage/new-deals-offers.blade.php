...
<body style="background:#f5f5f5;">
    ...
    <div class="travel">
        <header class="travel__bg">
            <div class="location__new--hero">
            <h1 class="">Deals &amp; Offers</h1>
            <p>Check out our mouth watering offers, we offer the best deals on our travel
                packages </p>
    ...
    <section class="location location__location xpad">
        ...
        <div class="location__wrapper location__loc--wrapper">
            ...
            <a href="{{url('location/'.$deal->id)}}" class="location__wrapper--link location__wrapper--london"
                style="background: url(storage/{{$deal->deals_image}});background-size: cover;">
